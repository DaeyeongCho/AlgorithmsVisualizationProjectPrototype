...
## ====================== 프로그램 ====================== ##
    ...
    def bottonStartFunc():
        ...
        algorithm = comboboxSelectAlgorithm.get()
        dataSize = spinboxDataSize.get()
        speedLimit = spinboxSpeedLimit.get()
        shuffleTime = spinboxShuffleTimes.get()
        searchValue = spinboxSearchValue.get()
        ...
        startSimulation(window, sortOrSearchAlgorithm, algorithm, dataSize, speedLimit, shuffleTime, searchValue, labelState[1], labelElapsedTime[1])
