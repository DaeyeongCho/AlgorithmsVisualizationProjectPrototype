...
SORT_ALGORITHMS = ["버블 정렬", "선택 정렬", "삽입 정렬", "병합 정렬", "퀵 정렬", "힙 정렬"]
...
LABEL_STATE = ["상태 : ", "---", "섞는 중...", "정렬 중...", "탐색 중...","섞기 완료!" , "정렬 완료!", "탐색 완료!", "최대힙 생성 중..."]
